...
namespace tp4EF.Migrations
{
    ...
    [Migration("20211120221254_inicial")]
            ...
            modelBuilder.Entity("CarroProducto", b =>
                {
                    ...
                    b.Property<int>("productossproducto_id")
                        .HasColumnType("int");

                    b.HasKey("carritosid", "productossproducto_id");

                    b.HasIndex("productossproducto_id");
            ...
            modelBuilder.Entity("CarroProducto", b =>
                {
                    ...
                    b.HasOne("tp1.Producto", null)
                        .WithMany()
                        .HasForeignKey("productossproducto_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
